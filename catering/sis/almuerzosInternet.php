...
<body>
    ...
    <main style="background-image:url(imagenes/fondoalmuerzo.jpg);background-size: 100% 100%;">
        <b><h2 style="background-color: white;color:#156f15;">Consumo Almuerzos con Pedidos (Internet) </h2></b>
        <br>
        
        
        <div style="width: 40%; float:left"> 
            <form id="login_form" class="form_class" action="guardad2.php?tipo=A" method="post">
    ...
    Empaque
                ...
                <input class="form-check-input" type="hidden" value="almuerzo" name="almuerzoExtra" style="align:left;">
                <!-- <label class="form-check-label" for="flexCheckCheckedDisabled">
    Almuerzo Extra
  </label> -->
  <br>
